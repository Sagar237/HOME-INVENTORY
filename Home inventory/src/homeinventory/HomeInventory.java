...
newButton.setHorizontalTextPosition(SwingConstants.CENTER);
 ...
 newButton.setFocusable(false); inventoryToolBar.add(newButton);
...
public void actionPerformed(ActionEvent e) { nextButtonActionPerformed(e); } 
});
...
gridConstraints.insets = new Insets(10, 10, 0, 10);
 ...
 gridConstraints.anchor = GridBagConstraints.EAST; getContentPane().add(itemLabel, gridConstraints);
...
locationLabel.setText("Location");
 ...
 gridConstraints.insets = new Insets(10, 10, 0, 10);
 gridConstraints.anchor = GridBagConstraints.EAST; getContentPane().add(locationLabel, gridConstraints);
...
gridConstraints.insets = new Insets(10, 0, 0, 10); 
gridConstraints.anchor = GridBagConstraints.WEST; getContentPane().add(priceTextField, gridConstraints);
...
gridConstraints.gridy = 4; gridConstraints.gridwidth = 5; 
...
y += dy; g2D.setFont(new Font("Arial", Font.BOLD, 12));
